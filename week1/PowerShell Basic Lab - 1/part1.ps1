...
$task5 = Get-CimInstance Win32_NetworkAdapterConfiguration | Where-Object {$_.DHCPEnabled -eq $true}`
| Select-Object DHCPServer
$task5 | Format-Table -HideTableHeaders | Out-String
